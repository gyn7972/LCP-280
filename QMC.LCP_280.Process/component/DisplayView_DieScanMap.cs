...
{
    public partial class DisplayView_DieScanMap : UserControl
    {
        ...
        public class DisplayItem
        {
            ...
            // ADD: 같은 State라도 그룹별로 색을 다르게 칠하기 위한 구분자
            // 0=기본(기존 동작), 1=Download(파랑), 2=Scan(빨강)
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (var item in _items)
            {
                ...
                // ADD: 그룹별 색상 우선 적용 (1=Download Blue, 2=Scan Red)
                // - 기존 State 의미(에러/픽 등)는 유지하되,
                //   Present/Empty 계열만 그룹 색으로 바꿔 "겹쳐보기"가 목적.
