...
namespace QMC.Common.IOUtil
{
    ...
    public sealed class Vacuum
    {
        ...
        /// </summary>
        public bool OnWaitOk(int timeoutMs = 2000, int pollMs = 1, int settleMs = 1, bool assumeOkWhenNoSensor = true)
        {
            On();
        ...
        /// </summary>
        public bool OffWaitOk(int timeoutMs = 2000, int pollMs = 1, int settleMs = 1, bool assumeOffWhenNoSensor = true)
        {
            Off();
