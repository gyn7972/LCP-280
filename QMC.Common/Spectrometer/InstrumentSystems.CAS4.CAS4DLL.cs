...
namespace InstrumentSystems.CAS4
{
    ...
    public class CAS4DLL
    {
        ...
        public const int mpidRelSaturation            = 25; ///<returns the relative saturation (between 0 and 100%) of the previous successful measurement for the @ref workingWithParameterSets "active parameter set" (for a detailed description see @ref saturationVersusSignalLevel). mpidRelSaturation can be checked against the <see cref="dpidRelSaturationMin"/> and <see cref="dpidRelSaturationMax"/> range, to ensure that the measurement has a sufficient signal level. However, to check for oversaturated measurements use <see cref="mpidMaxADCValue"/> and check it against <see cref="dpidADCRange"/>. Because with averaging, mpidRelSaturation might be < 100% even though there were saturated spectra!
        ...
        /// <remarks>
        /// APort=1 is pin 8 and APort=2 for pin 7 of the DB9 connector of the PCI/PCIe card or the trigger connector on the rear panel of the CAS140CT with USB interface.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="ADevice">The device / CASID</param>
        /// <param name="Index">Index ranging from 0 to 16, identifying which index should be returned. 0 returns the common index, sometimes also refered to as Ra, which is the average of the indices 1..8.</param>
