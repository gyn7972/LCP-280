...
namespace InstrumentSystems.CAS4
{
    ...
    public static partial class CAS4DLL
    {
        ...
        /// </remarks>
        [DllImport(CASLibName)]
        public static extern int hcasGetInteger(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, ref nint AValue);
        ...
        /// </remarks>
        [DllImport(CASLibName)]
        public static extern int hcasSetInteger(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, nint AValue);
        ...
        /// </remarks>
        [DllImport(CASLibName)]
        public static extern int hcasGetFloat(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, ref double AValue);
        ...
        /// </remarks>
        [DllImport(CASLibName)]
        public static extern int hcasSetFloat(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, double AValue);

        [DllImport(CASLibName, EntryPoint = "hcasGetString")]
        private static extern int _hcasGetString(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [In] byte[] AIndexString, [In,Out] byte[] AValue, ref nuint AMaxLen);
        ...
        /// </remarks>
        public static int hcasGetString(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, string AIndexString, StringBuilder AValue, ref nuint AMaxLen)
        {
            nuint initialMaxLen = 0;
            ...
            if (AValue != null) {
                ...
                if (utf8Bytes.Length > (int)initialMaxLen)
                    initialMaxLen = (nuint)utf8Bytes.Length;
                else
        ...
        /// </remarks>
        [DllImport(CASLibName)]
        public static extern int hcasSetString(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, [MarshalAs(UnmanagedType.LPUTF8Str)] string AValue);
        ...
        /// </remarks>
        [DllImport(CASLibName)]
        public static extern int hcasGetBuffer(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, IntPtr AValue, ref nuint ABufferSize);
        ...
        [DllImport(CASLibName)]
        public static extern int hcasSetBuffer(nuint AHandle, int AWhat, nint AIndex1, nint AIndex2, [MarshalAs(UnmanagedType.LPUTF8Str)] string AIndexString, IntPtr AValue, nuint ABufferSize);
        ///@}
