...
namespace QMC.LCP_280.Process.Unit
{
    ...
    {
        private const string UNIT_NAME = "IndexChipProbeController";

        private Equipment EquipmentInstance => Equipment.Instance;

        private IndexChipProbeController _unit;
        private IndexChipProbeControllerConfig _config;
        ...
        private void InitializeUnit()
        {
            try
            {
                ...
                {
                    _unit = raw as IndexChipProbeController;
                    _config = _unit?.IndexChipProbeControllerConfig;
                }
        ...
        private void PopulateAllAxesInJogControl()
        {
            try
            {
                ...
                jogControl.SetTeachingAxisList(names);
            }
            catch (Exception ex)
            {
                Debug.WriteLine("PopulateAllAxesInJogControl 오류: " + ex.Message);
            }
        }
        #endregion
        ...
        private void InitializeDigitalIO()
        {
            try
            {
                ...
                if (eq.Units.TryGetValue(UNIT_NAME, out var raw) && raw is IndexChipProbeController controller && controller.IndexChipProbeControllerConfig != null)
                {
