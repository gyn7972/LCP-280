...
namespace QMC.LCP_280.Process.Unit
{
    ...
    {
        private const string UNIT_NAME = "IndexChipProberUnit";
        private Equipment Equipment => Equipment.Instance;
        private IndexChipProber IndexChipProberUnit { get; set; }
        ...
        public IndexChipProberUnit_Config()
        {
            ...
            Console.WriteLine($"✅ IndexChipProberUnit_Config 생성자 완료");
        }
        ...
        private void InitializeUnit()
        {
            try
            {
                ...
                {
                    IndexChipProberUnit = unit as IndexChipProber;
                }

                if (IndexChipProberUnit == null)
                {
