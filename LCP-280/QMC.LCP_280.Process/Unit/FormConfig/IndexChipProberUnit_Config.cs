...
namespace QMC.LCP_280.Process.Unit
{
    ...
    {
        private const string UNIT_NAME = "IndexChipProber";

        private Equipment EquipmentInstance => Equipment.Instance;

        private IndexChipProber _unit;
        private IndexChipProberConfig _config;
        ...
        private void InitializeUnit()
        {
            try
            {
                ...
                {
                    _unit = raw as IndexChipProber;
                    _config = _unit?.IndexChipProberConfig;
                }
        ...
        private void InitializeDigitalIO()
        {
            try
            {
                ...
                if (eq.Units.TryGetValue(UNIT_NAME, out var raw) && raw is IndexChipProber prober && prober.IndexChipProberConfig != null)
                {
