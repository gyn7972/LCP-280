...
namespace QMC.LCP_280.Process.Unit
{
    ...
    public partial class OutputDieTransferUnit_Config : Form
    {
        ...
        private OutputDieTransfer _OutputDieTransfer { get; set; }
        ...
        public OutputDieTransferUnit_Config()
        {
            ...
            Console.WriteLine($"✅ OutputDieTransferUnit_Config 생성자 완료");
        }
        ...
        private void btnCurrentPos_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var kv in tp.AxisPositions)
                {
                    ...
                    // 2) Unit의 축 사전 키로 찾기
                    if (axis == null && _OutputDieTransfer.Axes != null)
                    {
                        QMC.Common.Motions.MotionAxis directAxis;
                        if (_OutputDieTransfer.Axes.TryGetValue(axisKey, out directAxis))
                            axis = directAxis;
                    }
                    ...
                    if (axis == null && _OutputDieTransfer.Axes != null)
                    {
                        foreach (var pair in _OutputDieTransfer.Axes)
                        {
                            var a = pair.Value;
