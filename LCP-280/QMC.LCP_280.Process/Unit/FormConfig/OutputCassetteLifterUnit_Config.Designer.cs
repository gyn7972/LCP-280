...
namespace QMC.LCP_280.Process.Unit
{
    partial class OutputCassetteLifterUnit_Config
    {
        ...
        private ListBoxItemsView axisListBoxItemsView; // (미사용 UI placeholder)
        ...
        private Panel positionItemPanel; // (미사용 UI placeholder)
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // axisListBoxItemsView (placeholder - currently not added to layout)
            // 
