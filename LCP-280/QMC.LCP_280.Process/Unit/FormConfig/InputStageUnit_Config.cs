...
namespace QMC.LCP_280.Process.Unit
{
    ...
    public partial class InputStageUnit_Config : Form
    {
        ...
        private InputStage _InputStage { get; set; }
        ...
        public InputStageUnit_Config()
        {
            ...
            Console.WriteLine($"✅ InputStageUnit_Config 생성자 완료");
        }
            ...
            try
            {
                ...
                foreach (var kv in tp.AxisPositions)
                {
                    ...
                    if (axis == null && _InputStage.Axes != null)
                    {
                        ...
                        if (_InputStage.Axes.TryGetValue(axisKey, out directAxis))
                            axis = directAxis;
                    }
                    ...
                    if (axis == null && _InputStage.Axes != null)
                    {
                        foreach (var pair in _InputStage.Axes)
                        {
                            var a = pair.Value;
