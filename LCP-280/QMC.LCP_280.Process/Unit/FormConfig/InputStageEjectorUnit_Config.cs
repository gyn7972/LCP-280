...
namespace QMC.LCP_280.Process.Unit
{
    ...
    public partial class InputStageEjectorUnit_Config : Form
    {
        ...
        private InputStageEjector _InputStageEjector { get; set; }
        ...
        public InputStageEjectorUnit_Config()
        {
            ...
            Console.WriteLine($"✅ InputStageEjectorUnit_Config 생성자 완료");
        }
            ...
            try
            {
                ...
                foreach (var kv in tp.AxisPositions)
                {
                    ...
                    if (axis == null && _InputStageEjector.Axes != null)
                    {
                        ...
                        if (_InputStageEjector.Axes.TryGetValue(axisKey, out directAxis))
                            axis = directAxis;
                    }
