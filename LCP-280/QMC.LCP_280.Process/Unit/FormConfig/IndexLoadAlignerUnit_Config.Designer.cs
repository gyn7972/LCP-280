    ...
    partial class IndexLoadAlignerUnit_Config
    {
        ...
        private void OnPositionItemSelected(object sender, int selectedIndex)
        {
            try
            {
                ...
                {
                    var aligner = unit as IndexLoadAligner;
                    if (aligner != null && selectedIndex >= 0 && selectedIndex < aligner.IndexLoadAlignerConfig.TeachingPositions.Count)
                    {
                        var tp = aligner.IndexLoadAlignerConfig.TeachingPositions[selectedIndex];
