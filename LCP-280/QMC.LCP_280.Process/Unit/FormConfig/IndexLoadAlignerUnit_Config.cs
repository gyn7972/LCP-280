...
namespace QMC.LCP_280.Process.Unit
{
    ...
    {
        private const string UNIT_NAME = "IndexLoadAlignerUnit";
        private Equipment Equipment => Equipment.Instance;
        private IndexLoadAligner IndexLoadAlignerUnit { get; set; }
        ...
        private void InitializeUnit()
        {
            try
            {
                ...
                {
                    IndexLoadAlignerUnit = unit as IndexLoadAligner;
                }

                if (IndexLoadAlignerUnit == null)
                {
