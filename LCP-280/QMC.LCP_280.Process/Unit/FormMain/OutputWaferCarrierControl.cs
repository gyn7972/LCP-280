...
namespace QMC.LCP_280.Process.Unit.FormMain
{
    public partial class OutputWaferCarrierControl : UserControl
    {
        ...
        public OutputWaferCarrierControl() : this(
        ...
        public OutputWaferCarrierControl(InputCassetteLifter cassetteLifter, InputFeeder ringTransfer, InputStage inputStage)
        {
            InitializeComponent();
