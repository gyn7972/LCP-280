...
{
    partial class OutputDieTransferUnit_Config
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // OutputDieTransferUnit_Config
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(96F, 96F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Dpi;
            this.ClientSize = new System.Drawing.Size(1264, 780);
            this.Controls.Add(this.mainTableLayoutPanel);
            this.Name = "OutputDieTransferUnit_Config";
            this.Text = "OutputDieTransfer Unit Configuration";
        ...
        // ===== Digital IO 초기화 (OutputDieTransfer Unit 관련 IO 자동 필터) =====
        private void InitializeDigitalIO()
        {
            try
            {
                ...
                const string UNIT_NAME = "OutputDieTransfer";
                if (eq?.Units != null &&
        ...
        private void SetAxisDefinitionsToAxisListBox()
        {
            try
            {
                // Equipment에서 OutputDieTransfer Unit 가져오기
        ...
        private void OnPositionItemSelected(object sender, int selectedIndex)
        {
            try
            {
                ...
                {
                    var transfer = unit as OutputDieTransfer;
                    if (transfer != null && selectedIndex >= 0 && selectedIndex < transfer.OutputDieTransferConfig.TeachingPositions.Count)
                    {
                        var tp = transfer.OutputDieTransferConfig.TeachingPositions[selectedIndex];
