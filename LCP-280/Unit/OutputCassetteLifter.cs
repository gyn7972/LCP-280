    ...
    public class OutputCassetteLifter : BaseUnit<OutputCassetteLifterConfig>
    {
        ...
        protected override void InitAlarm()
        {
            ...
            if (loadedAlarms == null || loadedAlarms.Count == 0)
            {
                ...
                alarm.Title = "Protrusion detection sensor triggered.";
                alarm.Cause = "Protrusion detection sensor triggered during cassette mapping. Please check the cassette and restart.";
                ...
                alarm.Title = "Feeder Y-axis is not in a safe position.";
                alarm.Cause = "Feeder Y-axis is not in a safe position. Please move Feeder Y-axis to a safe position and restart.";
                alarm.Source = source;// this.UnitName;
                alarm.Grade = AlarmInfo.AlarmType.Error.ToString();
                m_dicAlarms.Add(alarm.Code, alarm);
                ...
                alarm.Title = "Cassette replacement required.";
                alarm.Cause = "There are no wafers left in the cassette. Please replace the cassette.";
                alarm.Source = source;// this.UnitName;
                ...
                alarm.Cause = "The wafer presence slot patterns of Input/Output cassettes are different. Please check both cassettes and rescan.";
                alarm.Source = source;// this.UnitName;
                alarm.Grade = AlarmInfo.AlarmType.Error.ToString();
        ...
        public int MoveToTeachingPosition(string positionName, bool isFine)
        {
            ...
            OutputCassetteLifterConfig.TeachingPositionName en;
        ...
        public int MoveToTeachingPositionBySelectionIndex(int teachingSelIndex, bool isFine = false)
        {
            ...
            switch (en)
            {
                case OutputCassetteLifterConfig.TeachingPositionName.MappingStart:
                case OutputCassetteLifterConfig.TeachingPositionName.MappingEnd:
                case OutputCassetteLifterConfig.TeachingPositionName.CassetteSlot_1:
                case OutputCassetteLifterConfig.TeachingPositionName.UnloadOffset:
                case OutputCassetteLifterConfig.TeachingPositionName.LoadPort:
