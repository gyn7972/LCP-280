...
namespace QMC.LCP_280.Process.Unit.FormMain
{
    public partial class SequenceManualControl : UserControl
    {
        ...
        private void InitializeButtonActions()
        {
            ...
            {
                { btn_Ready_InputWafer, ("Wafer", "Ready") },
                { btn_Start_InputWafer, ("Wafer", "Start") },
                { btn_Reset_InputWafer, ("Wafer", "Reset") },

                { btn_Ready_ChipLoading, ("LoadArm", "Ready") },
                { btn_Start_ChipLoading, ("LoadArm", "Start") },
                { btn_Reset_ChipLoading, ("LoadArm", "Reset") },

                { btn_Ready_Process, ("Index", "Ready") },
                { btn_Start_Process, ("Index", "Start") },
                { btn_Reset_Process, ("Index", "Reset") },

                { btn_Ready_ChipUnloading, ("UnloadArm", "Ready") },
                { btn_Start_ChipUnloading, ("UnloadArm", "Start") },
                { btn_Reset_ChipUnloading, ("UnloadArm", "Reset") },

                { btn_Ready_OutputWafer, ("Bin", "Ready") },
                { btn_Start_OutputWafer, ("Bin", "Start") },
                { btn_Reset_OutputWafer, ("Bin", "Reset") }
            };
        }
