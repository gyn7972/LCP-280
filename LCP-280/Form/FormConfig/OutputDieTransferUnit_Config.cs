...
{
    public partial class OutputDieTransferUnit_Config : Form
    {
        private const string _UNIT_NAME = "OutputDieTransfer";

        private Equipment _Equipment => Equipment.Instance;
        private OutputDieTransfer _unit;
        private OutputDieTransferConfig _cfg;
        private OutputDieTransferRecipe TeachingRecipe => _cfg?.TeachingRecipe; // [ADD]
        ...
        public OutputDieTransferUnit_Config()
        {
            InitializeComponent();
            ...
            this.Shown += OutputDieTransferUnit_Config_Shown;
            this.FormClosed += OutputDieTransferUnit_Config_FormClosed;
        ...
        private void OutputDieTransferUnit_Config_Shown(object sender, EventArgs e)
        {
        ...
        private void OutputDieTransferUnit_Config_FormClosed(object sender, FormClosedEventArgs e)
        {
            EquipmentRecipe.CurrentRecipeChanged -= EquipmentRecipe_CurrentRecipeChanged;
        }
        ...
        private void ReloadTeachingFromRecipeAndRefreshUi()
        {
            ...
            // ★ [ADD] 캐시 강제 무효화 후 최신 recipe를 다시 받기
            try { _cfg.InvalidateTeachingRecipeCache(); } catch { }
            ...
            // ★ [ADD] (선택) 편집기 선택 상태가 남아있으면 화면상 "안바뀜"처럼 보일 수 있어 초기화
            try
            {
                positionTeachingControl?.UpdateEditorProperties(new PropertyCollection());
            }
            catch { /* ignore */ }
        ...
        private void InitializeUnit()
        {
            try
            {
                ...
                {
                    _unit = unit as OutputDieTransfer;
                    _cfg = _unit?.Config;
                }
