...
namespace QMC.LCP_280.Process.Unit
{
    public partial class InputDieTransferUnit_Config : Form
    {
        ...
        private InputDieTransferRecipe TeachingRecipe => _cfg?.TeachingRecipe; // [ADD]
        ...
        public InputDieTransferUnit_Config()
        {
            ...
            this.Shown += InputDieTransferUnit_Config_Shown;
            this.FormClosed += InputDieTransferUnit_Config_FormClosed;
        ...
        private void InputDieTransferUnit_Config_Shown(object sender, EventArgs e)
        {
        ...
        private void InputDieTransferUnit_Config_FormClosed(object sender, FormClosedEventArgs e)
        {
            EquipmentRecipe.CurrentRecipeChanged -= EquipmentRecipe_CurrentRecipeChanged;
        }
