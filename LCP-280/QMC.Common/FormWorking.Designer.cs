...
namespace QMC.Common
{
    partial class FormWorking
    {
        ...
        private void FormConfig_Resize(object sender, System.EventArgs e)
        {
            ...
            if (workingTabControl != null && workingTabControl.Dock != System.Windows.Forms.DockStyle.Fill)
            {
                workingTabControl.Size = this.ClientSize;
                Console.WriteLine($"   TabControl 크기 동기화: {workingTabControl.Size}");
            }
