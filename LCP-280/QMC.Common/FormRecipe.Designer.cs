...
namespace QMC.Common
{
    partial class FormRecipe
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 🔧 크기 변경 이벤트 추가 (디버깅용)
            this.Resize += FormRecipe_Resize;
        }
        
        /// <summary>
        /// 🔧 폼 크기 변경 이벤트 (디버깅용)
        /// </summary>
        private void FormRecipe_Resize(object sender, System.EventArgs e)
        {
            Console.WriteLine($"📏 FormRecipe 크기 변경됨: Size={this.Size}, ClientSize={this.ClientSize}");
            
            // TabControl이 존재하고 Dock이 Fill이 아닌 경우 크기 동기화
            if (recipeTabControl != null && recipeTabControl.Dock != System.Windows.Forms.DockStyle.Fill)
            {
                recipeTabControl.Size = this.ClientSize;
                Console.WriteLine($"   TabControl 크기 동기화: {recipeTabControl.Size}");
            }
