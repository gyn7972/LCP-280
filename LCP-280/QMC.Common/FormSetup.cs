...
namespace QMC.Common
{
    public partial class FormSetup : Form
    {
        ...
        private void InitializesetupUI()
        {
            ...
            setupTabControl.Dock = DockStyle.None;
        ...
        /// <summary>
        /// FormManager에서 setup 타입으로 등록된 폼들을 탭으로 로드
        /// </summary>
        ...
        private void LoadFormIntoTab(TabPage tabPage, FormInfo formInfo)
        {
            try
            {
                ...
                if (!_tabFormInstances.ContainsKey(tabPage))
                {
                    ...
                    if (setupTabControl != null)
                    {
                        int availableWidth = setupTabControl.Width;
                        int availableHeight = setupTabControl.Height - _tabHeight - 20; // 탭 높이 제외
                ...
                else
                {
                    ...
                    {
                        int availableWidth = setupTabControl.Width;
                        int availableHeight = setupTabControl.Height - _tabHeight; // 탭 높이 제외
        ...
        public void SetPanelSize(int width, int height)
        {
            ...
            Console.WriteLine($"   현재 Formsetup 크기: Size={this.Size}, ClientSize={this.ClientSize}");
            ...
            if (setupTabControl != null)
            {
                Console.WriteLine($"   TabControl 크기 조정: {setupTabControl.Size} → {new Size(width, height)}");
                setupTabControl.Size = new Size(width, height);
